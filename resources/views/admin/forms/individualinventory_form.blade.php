            ...
            <form method="POST" action="{{route('forms.individualinventory_formsubmit')}}" enctype="multipart/form-data" style="font-size: 12px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2" >
                            <input type="text" name="sy" id="sy" readonly value="{{App\Schoolyear::where('status', 1)->first()->name}}" class="form-control cambria" style="text-transform: uppercase;font-weight: bold; font-size: 10px;">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-2">
                            <select name="a2" id="a2" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                    ...
                    <div class="row">
                        ...
                        <input type="text" name="a3" id="a3" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-1.1">
                            <p class="cambria" >Religion: &nbsp;&nbsp;</p>
                        </div>
                        <div class="col-md-2.9" style="padding-right: 20px;">
                        <input type="text" name="a4" id="a4" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2.1">
                            <p class="cambria" >Nationality: &nbsp;&nbsp;</p>
                        </div>
                        <div class="col-md-3.5">
                        <input type="text" name="a5" id="a5" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <input type="text" name="a6" id="a6" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-1">
                            <p class="cambria" >Tel. No.:  </p>
                        </div>
                        <div class="col-md-3.5" style="padding-right: 20px;">
                            <input type="text" name="a7" id="a7" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2.1">
                            <p class="cambria" >Email Address: &nbsp;&nbsp;</p>
                        </div>
                        <div class="col-md-3.5" style="width: 25%;">
                        <input type="email" name="a8" id="a8" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <input type="text" name="a9" id="a9" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                            <p class="cambria" style="text-align: right; line-height: 20px;">Home Address: </p>
                        </div>
                        <div class="col-md-5.5" style="width: 30%;">
                        <input type="text" name="a5" id="a5" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;" value="{{$student->address}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b1" id="b1"  class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b2" id="b2" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b3" id="b3" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b4" id="b4" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b5" id="b5" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b6" id="b6" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b7" id="b7" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b8" id="b8" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b9" id="b9" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b10" id="b10" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b11" id="b11" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b12" id="b12" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b13" id="b13" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b14" id="b14" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b15" id="b15" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b16" id="b16" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="b17" id="b17" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-5">
                        <input type="text" name="b18" id="b18" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-2">
                        <input type="text" name="d2" id="d2" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-2">
                        <input type="text" name="d5" id="d5" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-2">
                        <input type="text" name="d8" id="d8" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-2">
                        <input type="text" name="d11" id="d11" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-2">
                        <input type="text" name="d14" id="d14" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-3">
                            <p class="cambria" style="line-height: 20px;">Guardian (if not living with Parents):   </p>
                        </div>
                        <div class="col-md-9">
                        <input type="text" name="e1" id="e1" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                        <input type="text" name="e2" id="e2" class="form-control cambria">
                        </div>
                        <div class="col-md-2.1" >
                            <p class="cambria">Contact No.: &nbsp; &nbsp; </p>
                        </div>
                        <div class="col-md-4">
                        <input type="text" name="e3" id="e3" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="e4" id="e4" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="e5" id="e5" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="e6" id="e6" class="form-control cambria">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-3">
                        <input type="text" name="f1" id="f1" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="f2" id="f2" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;" readonly>
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="f3" id="f3" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="f4" id="f4" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                        <input type="text" name="f5" id="f5" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="f6" id="f6" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;" readonly>
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="f7" id="f7" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="f8" id="f8" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                        <input type="text" name="f9" id="f9" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="f10" id="f10" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="f11" id="f11" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="f12" id="f12" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-4">
                        <input type="text" name="g1" id="g1" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                        <input type="text" name="g2" id="g2" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                        <input type="text" name="g3" id="g3" class="form-control cambria"  style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-4">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="h1" id="h1" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="h2" id="h2" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="h3" id="h3" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="h4" id="h4" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="h5" id="h5" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="h6" id="h6" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px; ">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="h7" id="h7" class="form-control cambria">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="j1" id="j1" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="j2" id="j2" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="j3" id="j3" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="j4" id="j4" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="j5" id="j5" class="form-control cambria">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <textarea name="k1" id="k1" cols="30" rows="3" class="form-control cambria"></textarea>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <textarea name="k2" id="k2" cols="30" rows="3" class="form-control cambria"></textarea>
                        </div>
                    </div>
