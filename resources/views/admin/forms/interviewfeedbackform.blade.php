        ...
        <div class="card-body">
                ...
                <div class="col-md-1">
                    <div class="radio">
                        <label for="radio1" class="form-check-label " >
                            <input type="radio" id="radio1" name="a1" value="1" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                ...
                <div class="col-md-1">
                     <div class="radio">
                        <label for="radio2" class="form-check-label ">
                            <input type="radio" id="radio2" name="a1" value="2" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                ...
                <div class="col-md-1">
                     <div class="radio">
                        <label for="radio3" class="form-check-label " >
                            <input type="radio" id="radio3" name="a1" value="3" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                ...
                <div class="col-md-1">
                     <div class="radio">
                        <label for="radio4" class="form-check-label " >
                            <input type="radio" id="radio4" name="a1" value="4" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                ...
                <div class="col-md-1">
                     <div class="radio">
                        <label for="radio5" class="form-check-label " >
                            <input type="radio" id="radio5" name="a1" value="5" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
            ...
            <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio1b" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio1b" name="a2" value="1" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>5</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio2b" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio2b" name="a2" value="2" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>4</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio3b" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio3b" name="a2" value="3" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>3</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio4b" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio4b" name="a2" value="4" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>2</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio5b" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio5b" name="a2" value="5" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>1</b></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio1c" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio1c" name="a3" value="1" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>5</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio2c" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio2c" name="a3" value="2" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>4</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio3c" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio3c" name="a3" value="3" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>3</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio4c" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio4c" name="a3" value="4" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>2</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio5c" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio5c" name="a3" value="5" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>1</b></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio1d" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio1d" name="a4" value="1" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>5</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio2d" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio2d" name="a4" value="2" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>2</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio3d" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio3d" name="a4" value="3" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>3</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio4d" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio4d" name="a4" value="4" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>2</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio5d" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio5d" name="a4" value="5" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>1</b></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio1e" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio1e" name="a5" value="1" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>5</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio2e" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio2e" name="a5" value="2" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>4</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio3e" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio3e" name="a5" value="3" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>3</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio4e" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio4e" name="a5" value="4" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>2</b></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="radio">
                            <label for="radio5e" class="form-check-label " style="padding-top: 10px;">
                                <input type="radio" id="radio5e" name="a5" value="5" class="form-check-input" style="height:2em;width:2em;margin-top: -3px;">
                                <span class="cambria" style="padding-left: 10px;"><b>1</b></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="a6" id="a6" class="form-control cambria" cols="30" rows="3" style="font-size: 16px;"></textarea>
                </div>
                <div>
