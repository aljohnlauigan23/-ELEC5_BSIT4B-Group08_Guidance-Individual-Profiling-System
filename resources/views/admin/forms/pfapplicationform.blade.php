            ...
            <form method="POST" action="{{route('forms.pfapplication_formsubmit')}}" enctype="multipart/form-data" style="font-size: 12px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="nickname" id="nickname" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-4">
                        <input type="text" name="email" id="email" class="form-control cambria">
                        </div>
                        <div class="col-md-2.1">
                            <p class="cambria" style="font-size: 16px;">Contact Number: </p>
                        </div>
                        <div class="col-md-4">
                        <input type="text" name="contactno" id="contactno" class="form-control cambria">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="a4" id="a4" class="form-control cambria" cols="30" rows="2"></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="a5" id="a5" class="form-control cambria" cols="30" rows="2"></textarea>
                    </div>
                    <br>
                    ...
                    <div class="row" style="padding-bottom: 10px;">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="b3" id="b3" class="form-control cambria">
                        </div>
                        <div class="col-md-2">
