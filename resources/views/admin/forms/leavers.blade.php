  ...
  <div class="container p-t-30">
    <div class="card">
        <div class="card-header">
            <h4>University Leaver's Checklist</h4>
        </div>
        <div class="card-body">
                                    ...
                                    <table class="table table-borderless table-data3" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow" style="font-size: 12px; padding: 5px;">
                                                ...
                                                <td><input type="number" name="req_fields" class="form-control" required="true" min="1" @if($form_settings) value="{{$form_settings->req_fields}}" @endif></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    </div>
