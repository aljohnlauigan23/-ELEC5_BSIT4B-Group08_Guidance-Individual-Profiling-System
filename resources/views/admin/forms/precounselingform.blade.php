    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="a1" id="a1" class="form-control cambria" cols="30" rows="2"></textarea>
            </div>
            <div class="form-group">
                ...
                <textarea name="a2" id="a2" class="form-control cambria" cols="30" rows="2"></textarea>
            </div>
            <div class="form-group">
                <label for="cc-payment" class="control-label mb-1 cambria" style="font-size: 16px;">3. Who is financing your studies?  </label>
                <textarea name="a3" id="a3" class="form-control cambria" cols="30" rows="2"></textarea>
            </div>
            <br>
            ...
            <div class="row" style="padding-bottom: 10px;">
                ...
                <div class="col-md-3">
                    <input type="text" name="b1" id="b1" class="form-control cambria">
                </div>
                <div class="col-md-2">
                    <p class="cambria" style="font-size: 16px; line-height: 20px; ">2. What is his/her contact number? </p> 
                </div>
                <div class="col-md-3">
                    <input type="text" name="b2" id="b2" class="form-control cambria">
                </div>
            </div>
            <div class="form-group">
                ...
                <textarea name="b3" id="b3" class="form-control cambria" cols="30" rows="2"></textarea>
            </div>
            <div class="row" style="padding-bottom: 10px;">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <input type="text" name="b4" id="b4" class="form-control cambria">
                </div>
            </div>
            <div class="row" style="padding-bottom: 10px;">
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    <input type="text" name="b5" id="b5" class="form-control cambria">
                </div>
                <div class="col-md-2">
                    <p class="cambria" style="font-size: 16px;line-height: 20px; ">6. When do you usually study?  </p> 
                </div>
                <div class="col-md-4">
                    <input type="text" name="b6" id="b6" class="form-control cambria">
                </div>
            </div>
            <div class="row" style="padding-bottom: 10px;">
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    <input type="text" name="b7" id="b7" class="form-control cambria">
                </div>
                <div class="col-md-1">
            ...
            <div class="form-group">
                ...
                <textarea name="c3" id="c3" class="form-control cambria" cols="30" rows="2"></textarea>
            </div>
            <div class="form-group">
                ...
                <textarea name="c4" id="c4" class="form-control cambria" cols="30" rows="2"></textarea>
            </div>
            <br>
            ...
            <div class="row" style="padding-bottom: 10px;">
                ...
                <div class="col-md-9">
                    <input type="text" name="d4" id="d4" class="form-control cambria">
                </div>
            </div>
            <div class="row" style="padding-bottom: 10px;">
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    <input type="text" name="d5" id="d5" class="form-control cambria">
                </div>
            </div>
            <br>
            ...
            <div class="row" style="padding-bottom: 10px;">
                <div class="col-md-12">
                    <textarea name="f1" id="f1" class="form-control cambria" cols="30" rows="2"></textarea>
                </div>
            </div>
            <div>
