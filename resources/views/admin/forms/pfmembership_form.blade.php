            ...
            <form method="POST" action="{{route('forms.pfmembership_formsubmit')}}" enctype="multipart/form-data" style="font-size: 12px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="a2" id="a2" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2.1" style="margin-left: 10px;">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-3">
                        <input type="email" name="a8" id="a8" class="form-control cambria" style="font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3">
                        <input type="text" name="a12" id="a12" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-3">
                            <select name="a13" id="a13" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        ...
                        <div class="col-md-3">
                        <input type="text" name="a14" id="a14" class="form-control cambria" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-4">
                        <input type="text" name="b1" id="b1" class="form-control cambria" placeholder="Name" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="b2" id="b2" class="form-control cambria" placeholder="Occupation" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-1.1" style="margin-left: 13px;">
                            <p class="cambria" >Mother: &nbsp;&nbsp;</p>
                        </div>
                        <div class="col-md-4">
                        <input type="text" name="b4" id="b4" class="form-control cambria" placeholder="Name" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="b5" id="b5" class="form-control cambria" placeholder="Occupation" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-4">
                        <input type="text" name="b6" id="b6" class="form-control cambria" placeholder="Contact No." style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-1.1" style="margin-left: 13px;">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-1">
                        <input type="number" name="b10" id="b10" class="form-control cambria" value="0" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-1">
                        <p class="cambria" style="font-size: 15px;">Birth Rank: </p>
                        </div>
                        <div class="col-md-1">
                        <input type="number" name="b11" id="b11" class="form-control cambria" value="1" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-3">
                        <input type="text" name="c1" id="c1" class="form-control cambria" placeholder="Name of School & Address" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="c2" id="c2" class="form-control cambria" placeholder="Program" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="c3" id="c3" class="form-control cambria" placeholder="Year Graduated" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="c4" id="c4" class="form-control cambria" placeholder="Honors Received" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2" >
                        ...
                        <div class="col-md-3">
                        <input type="text" name="c5" id="c5" class="form-control cambria" placeholder="Name of School & Address" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="c6" id="c6" class="form-control cambria" placeholder="Program" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="c7" id="c7" class="form-control cambria" placeholder="Year Graduated" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="c8" id="c8" class="form-control cambria" placeholder="Honors Received" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2" >
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-3">
                        <input type="text" name="c13" id="c13" class="form-control cambria" placeholder="Name of School & Address" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-3">
                        <input type="text" name="c14" id="c14" class="form-control cambria" placeholder="Program" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="c15" id="c15" class="form-control cambria" placeholder="Year Graduated" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                        <div class="col-md-2">
                        <input type="text" name="c16" id="c16" class="form-control cambria" placeholder="Honors Received" style="text-transform: uppercase;font-weight: bold;">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2" >
                        ...
                        <div class="col-md-10">
                        <input type="text" name="d1" id="d1" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2" >
                        ...
                        <div class="col-md-10">
                        <input type="text" name="d2" id="d2" class="form-control cambria">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2" >
                        ...
                        <div class="col-md-10">
                        <input type="text" name="d3" id="d3" class="form-control cambria">
                        </div>
                    </div>
