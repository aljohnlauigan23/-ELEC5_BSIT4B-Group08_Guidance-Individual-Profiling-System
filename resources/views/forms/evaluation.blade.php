...
<body>
    ...
    <div style="height: 1500px;">
        <p class="calibri" style="text-align: left;font-style: italic;">Guidance Form 20</p>
        ...
        <div class="container-fluid">
            ...
            <p class="cambria" style="text-align: center;font-weight: bold;">EVALUATION FORM</p>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-6" style="margin-left: -60px;">
                    <p class="cambria" style="text-align: left;font-weight: bold;">{{$activity->title}}</p>
                ...
                <div class="col-md-2">
                    <p class="cambria" style="text-align: left;font-weight: bold;">{{Carbon\Carbon::parse($activity->date)->toFormattedDateString()}}</p>
            ...
            <div class="row">
                ...
                <div class="col-md-10" style="margin-left: -60px;">
                    <p class="cambria" style="text-align: left;font-weight: bold;">{{$activity->facilitators}}</p>
                    <hr style="margin-left: 0px;border-bottom: 1px solid;margin-top: -17px;">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6" style="text-align: left;padding-left: 150px;">
            ...
            <table class="table table-bordered">
                <thead>
                <tr>
                    <th style="text-align: center; font-weight: bold;" class="cambria">Factors</th>
                    <th style="text-align: center; font-weight: bold;" class="cambria">5</th>
                    <th style="text-align: center; font-weight: bold;" class="cambria">4</th>
                    <th style="text-align: center; font-weight: bold;" class="cambria">3</th>
                    <th style="text-align: center; font-weight: bold;" class="cambria">2</th>
                    <th style="text-align: center; font-weight: bold;" class="cambria">1</th>
                    <th style="text-align: center; font-weight: bold;" class="cambria">NA</th>
                </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="cambria" style="text-align: left;">A. Presentation</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">1.	Organization and Flow</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">2.	Clarity</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">3.	Conciseness</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">4.	Methodology</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">5.	Quality of Materials</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">6.	Pacing of Activities</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">7.	Timing of the Activity</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;">B. Resource Speaker/s</td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">1.	Preparedness</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">2.	Knowledge</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">3.	Communication</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;">C. Venue</td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">1.	Quality of Audio-Visual Presentation</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">2.	Room Set-Up</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">3.	Sound System</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">4.	Lighting</td>
    ...
    <div style="height: 1500px;">
        ...
        <div class="container-fluid">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td class="cambria" style="text-align: left;">F. Theme </td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">1.	Attainment of Objectives</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">2.	Relevance of the Activity</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;">G. Impact</td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                        <td style="text-align: center;background-color: #adaaaa;"></td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">1.	Contribution of Knowledge</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">2.	Skills Development</td>
                    ...
                    <tr>
                        <td class="cambria" style="text-align: left;padding-left: 30px;">3.	Involvement of Participants</td>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <p class="cambria" style="text-align: left;">H. Comments and Suggestions for Improvement</p>
                </div>
                <div class="col-md-12">
                    <p class="cambria" style="text-align: left;"><u>{{$prop->h1}}</u></p>
                </div>
            </div>
        </div>
        <div class="container-fluid">
