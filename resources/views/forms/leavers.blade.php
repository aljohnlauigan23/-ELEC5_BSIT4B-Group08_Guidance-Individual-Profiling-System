...
<html>
<head>
  <title>University Leavers Checklist</title>
...
<body>
    ...
    <div style="height: 1500px;">
        ...
        <div class="container-fluid">
            ...
            <p class="cambria" style="text-align: center;font-weight: bold;">UNIVERSITY LEAVER’S CHECKLIST</p>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                <p class="cambria" style="text-align: left;">{{$leaver->others}}</p>
                <hr style="margin-left: -40px;border-bottom: 1px solid;@if($leaver->others) margin-top: -20px; @endif">
                </div>
            </div>
            <p></p>
        ...
        <p class="calibri" style="text-align: left;font-style: italic;padding-top: 300px;">Guidance Form 25</p>
    </div>
    @endforeach
