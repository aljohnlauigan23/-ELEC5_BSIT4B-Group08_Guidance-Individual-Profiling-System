...
<body>
    ...
    <div style="height: 1500px;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-5" style="text-align: right;">
                    <img src="{{URL::to('peers.png')}}" style="width: 100px;height:100px;" alt="">
                </div>
        ...
        <div class="container-fluid">
            ...
            <p class="cambria margin-0rem fsize_15" style="text-align: center;font-weight: bold;padding-top: 30px;padding-bottom: 30px;">Application Form</p>
            <div class="row">
                <div class="col-md-1">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <hr style="margin-left: -40px;border-bottom: 1px solid;@isset($prop->email)margin-top: -17px;@endisset">
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    ...
                    <hr style="margin-left: -20px;border-bottom: 1px solid;@isset($prop->contactno)margin-top: -17px;@endisset">
                </div>
            </div>
        </div>
    </div>
