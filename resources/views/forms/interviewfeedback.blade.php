...
<body>
    ...
    <div style="height: 1500px;">
        ...
        <div class="container-fluid">
            ...
            <p class="cambria" style="text-align: center;font-weight: bold;">PRE-COUNSELING INTERVIEW FEEDBACK FORM</p>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1">
                ...
                <div class="col-md-2">
                    <p class="cambria" style="text-align: left;font-weight: bold;">{{Carbon\Carbon::parse($feedback->created_at)->toFormattedDateString()}}</p>
            ...
            <p class="cambria" style="text-align: left;">Are there any comments you would wish to make? </p>
            <p class="cambria" style="text-align: left;"><u>{{$feedback->a6}}</u></p>
            <br>
            <p class="cambria" style="text-align: center;font-style: italic;">Thank you for your feedback!</p>
        </div>
        
        <p class="calibri" style="text-align: left;font-style: italic;padding-top: 300px;">Guidance Form 20B</p>
    </div>
    @endforeach
