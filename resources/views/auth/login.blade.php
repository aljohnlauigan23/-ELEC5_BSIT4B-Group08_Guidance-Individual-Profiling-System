                        ...
                        <div class="login-form">
                            <form method="POST" action="{{ route('login') }}" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="email" placeholder="Username/ID" style="border: 1px solid rgba(0,0,0,.125);">

                                    
                                </div>
                                <div class="form-group pass_show">
                                    <label>Password</label>
                                    <input id="password" class="au-input au-input--full" type="password" name="password" placeholder="Password" style="border: 1px solid rgba(0,0,0,.125);" autocomplete="off">
                                </div>
