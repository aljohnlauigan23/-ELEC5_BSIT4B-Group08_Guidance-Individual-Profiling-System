    ...
    <div class="page-wrapper">
        ...
        <header class="header-mobile d-block d-lg-none">
            <div class="header-mobile__bar">
                <p>Guidance Individual Profiling System</p>
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <!-- <img src="{{URL::to('admin/images/icon/logo.png')}}" alt="BISU" /> -->
                            BISU BALILIHAN
                        </a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            ...
            <div class="menu-sidebar__content js-scrollbar1" style="ackground: #6A9CF2;background: -webkit-linear-gradient(left, #6A9CF2, #E8EDF8);background: -moz-linear-gradient(left, #6A9CF2, #E8EDF8);background: linear-gradient(to right, #6A9CF2, #E8EDF8);">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('studentprofile')">
                            <a class="js-arrow" href="{{route('forms.studentprofile')}}">
